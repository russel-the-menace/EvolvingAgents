...
import {
  ...
  Copy, PanelLeftClose, PanelLeftOpen, Pencil, Plus, Search, SendHorizontal, Settings2,
...
export function App() {
  ...
  const [dailyModel, setDailyModel] = useState<DailyModel>(() => window.localStorage.getItem('mindclone.daily-model') === 'deepseek-reasoner' ? 'deepseek-reasoner' : 'deepseek-chat');
